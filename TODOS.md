...
- [x] **The gate extends past the table to every other screen.** Added 2026-07-26 as `audit-packaged-screen-layout.mjs`, covering first-run setup, home menu, settings, mode select, career lobby, arrival fly-through, live table, and the pause overlay at 1280×720, 1600×900, and 1920×1080, with a screenshot of each written to `work/screen-layout/` so the aesthetic half of a review can be done by looking.
