...
describe("A09 wager report", () => {
  it("keeps the offline/reference and live-adoption boundaries visible", () => {
    ...
    const legal = { playerId: "hero", toCall: 0, check: true, fold: true, call: false, callAmount: 0, bet: { min: 100, max: 1003 }, allIn: true, allInTo: 1003, raisingReopened: true } as const;
