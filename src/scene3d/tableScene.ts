...
function buildRoom(scene: Scene, bundle: TableSceneResources): void {
  ...
  */
  ...
  const floor = new Mesh(resources.track(new PlaneGeometry(12, 12)), floorMaterial);
  ...
  */
  const inlay = new Mesh(
    resources.track(new CircleGeometry(2.9, 48)),
  ...
  const horizon = new Mesh(
    ...
    resources.track(new PlaneGeometry(11, 4.6)),
    wallMaterial(bundle, 6, 2),
  );
  horizon.position.set(0, 2.3, -5.5);
  scene.add(horizon);
  ...
  const horizonBand = new Mesh(
    resources.track(new PlaneGeometry(11, 0.10)),
  ...
  horizonBand.position.set(0, 1.1, -5.47);
  ...
  */
  for (const side of [-1, 1]) {
    ...
    sideWall.position.set(side * 5.5, 2.3, 0);
    ...
    sideCove.position.set(side * 5.47, 1.1, 0);
  ...
  nearWall.position.set(0, 2.3, 5.5);
  ...
  nearCove.position.set(0, 1.1, 5.47);
  ...
  const ceiling = new Mesh(
    resources.track(new PlaneGeometry(11, 11)),
  ...
  */
  ...
  for (const x of [-3.7, -1.25, 1.25]) {
    const sconce = new Mesh(sconceGeometry, sconceMaterial);
    sconce.position.set(x, 1.62, -5.47);
    scene.add(sconce);
  }
  ...
  doorFrame.position.set(3.75, 1.2, -5.45);
  scene.add(doorFrame);
  const door = new Mesh(
  ...
  door.position.set(3.75, 1.14, -5.43);
  scene.add(door);
  ...
  exitSign.position.set(3.75, 2.52, -5.42);
  scene.add(exitSign);
