...
export const ACTION_DEFINITIONS: readonly ActionDefinition[] = [
  ...
  {
    id: "menu.up",
    label: formatMessage("actionMap.menu.up.label"),
    context: "menu",
    category: "menu",
    remappable: true,
    defaults: { keyboard: ["arrowup"], gamepad: ["button:12"] },
    pointerHint: formatMessage("actionMap.menu.up.pointerHint"),
  },
  {
    id: "menu.down",
    label: formatMessage("actionMap.menu.down.label"),
    context: "menu",
    category: "menu",
    remappable: true,
    defaults: { keyboard: ["arrowdown"], gamepad: ["button:13"] },
    pointerHint: formatMessage("actionMap.menu.down.pointerHint"),
  },
  {
    id: "menu.left",
    label: formatMessage("actionMap.menu.left.label"),
    context: "menu",
    category: "menu",
    remappable: true,
    defaults: { keyboard: ["arrowleft"], gamepad: ["button:14"] },
    pointerHint: formatMessage("actionMap.menu.left.pointerHint"),
  },
  {
    id: "menu.right",
    label: formatMessage("actionMap.menu.right.label"),
    context: "menu",
    category: "menu",
    remappable: true,
    defaults: { keyboard: ["arrowright"], gamepad: ["button:15"] },
    pointerHint: formatMessage("actionMap.menu.right.pointerHint"),
  },
  {
    id: "menu.activate",
    label: formatMessage("actionMap.menu.activate.label"),
    context: "menu",
    category: "menu",
    remappable: true,
    defaults: { keyboard: ["enter", "space"], gamepad: ["button:0"] },
    pointerHint: formatMessage("actionMap.menu.activate.pointerHint"),
  },
  {
    id: "menu.back",
    label: formatMessage("actionMap.menu.back.label"),
    context: "menu",
    category: "system",
    remappable: true,
    defaults: { keyboard: ["escape"], gamepad: ["button:1"] },
    pointerHint: formatMessage("actionMap.menu.back.pointerHint"),
  },

  // ----- Gameplay actions (table context) -----
  {
    id: "game.fold",
    label: formatMessage("actionMap.game.fold.label"),
    context: "game",
    category: "gameplay",
    remappable: true,
    defaults: { keyboard: ["f"], gamepad: ["button:2"] },
    pointerHint: formatMessage("actionMap.game.fold.pointerHint"),
  },
  {
    id: "game.checkCall",
    label: formatMessage("actionMap.game.checkCall.label"),
    context: "game",
    category: "gameplay",
    remappable: true,
    defaults: { keyboard: ["c"], gamepad: ["button:0"] },
    pointerHint: formatMessage("actionMap.game.checkCall.pointerHint"),
  },
  {
    id: "game.raiseCustom",
    label: formatMessage("actionMap.game.raiseCustom.label"),
    context: "game",
    category: "gameplay",
    remappable: true,
    defaults: { keyboard: ["r"], gamepad: ["button:3"] },
    pointerHint: formatMessage("actionMap.game.raiseCustom.pointerHint"),
  },
  {
    id: "game.raiseDouble",
    label: formatMessage("actionMap.game.raiseDouble.label"),
    context: "game",
    category: "gameplay",
    remappable: true,
    defaults: { keyboard: ["2"], gamepad: [] },
    pointerHint: formatMessage("actionMap.game.raiseDouble.pointerHint"),
  },
  {
    id: "game.raiseTwoFive",
    label: formatMessage("actionMap.game.raiseTwoFive.label"),
    context: "game",
    category: "gameplay",
    remappable: true,
    defaults: { keyboard: ["5"], gamepad: [] },
    pointerHint: formatMessage("actionMap.game.raiseTwoFive.pointerHint"),
  },
  {
    id: "game.raiseTriple",
    label: formatMessage("actionMap.game.raiseTriple.label"),
    context: "game",
    category: "gameplay",
    remappable: true,
    defaults: { keyboard: ["3"], gamepad: [] },
    pointerHint: formatMessage("actionMap.game.raiseTriple.pointerHint"),
  },
  {
    id: "game.pot",
    label: formatMessage("actionMap.game.pot.label"),
    context: "game",
    category: "gameplay",
    remappable: true,
    defaults: { keyboard: ["p"], gamepad: [] },
    pointerHint: formatMessage("actionMap.game.pot.pointerHint"),
  },
  {
    id: "game.allIn",
    label: formatMessage("actionMap.game.allIn.label"),
    context: "game",
    category: "gameplay",
    remappable: true,
    defaults: { keyboard: ["a"], gamepad: ["button:5"] },
    pointerHint: formatMessage("actionMap.game.allIn.pointerHint"),
  },
  {
    id: "game.peek",
    label: formatMessage("actionMap.game.peek.label"),
    context: "game",
    category: "gameplay",
    remappable: true,
    defaults: { keyboard: ["space"], gamepad: ["button:4"] },
    pointerHint: formatMessage("actionMap.game.peek.pointerHint"),
  },
  {
    id: "game.history",
    label: formatMessage("actionMap.game.history.label"),
    context: "game",
    category: "gameplay",
    remappable: true,
    defaults: { keyboard: ["h"], gamepad: ["button:9"] },
    pointerHint: formatMessage("actionMap.game.history.pointerHint"),
  },
  {
    id: "game.pause",
    label: formatMessage("actionMap.game.pause.label"),
    context: "game",
    category: "system",
    remappable: true,
    defaults: { keyboard: ["escape"], gamepad: ["button:8"] },
    pointerHint: formatMessage("actionMap.game.pause.pointerHint"),
  },
  {
    id: "camera.left",
    label: formatMessage("actionMap.camera.left.label"),
    context: "game",
    category: "camera",
    remappable: true,
    defaults: { keyboard: ["q"], gamepad: ["button:14"] },
    pointerHint: formatMessage("actionMap.camera.left.pointerHint"),
  },
  {
    id: "camera.right",
    label: formatMessage("actionMap.camera.right.label"),
    context: "game",
    category: "camera",
    remappable: true,
    defaults: { keyboard: ["e"], gamepad: ["button:15"] },
    pointerHint: formatMessage("actionMap.camera.right.pointerHint"),
  },
  {
    id: "camera.center",
    label: formatMessage("actionMap.camera.center.label"),
    context: "game",
    category: "camera",
    remappable: true,
    defaults: { keyboard: ["x"], gamepad: ["button:13"] },
    pointerHint: formatMessage("actionMap.camera.center.pointerHint"),
  },
  {
    id: "speed.down",
    label: formatMessage("actionMap.speed.down.label"),
    context: "game",
    category: "speed",
    remappable: true,
    defaults: { keyboard: ["[", "-"], gamepad: ["button:6"] },
    pointerHint: formatMessage("actionMap.speed.down.pointerHint"),
  },
  {
    id: "speed.up",
    label: formatMessage("actionMap.speed.up.label"),
    context: "game",
    category: "speed",
    remappable: true,
    defaults: { keyboard: ["]", "=", "+"], gamepad: ["button:7"] },
    pointerHint: formatMessage("actionMap.speed.up.pointerHint"),
  },
];
