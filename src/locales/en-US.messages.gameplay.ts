...
// The restrained tournament HUD (E27-008): global state only, corner
  ...
  "table.hud.handPlayers": "In hand",
  "table.hud.tournamentPlayers": "Tournament players",
  "table.context.stack": "Stack",
  "table.context.effective": "Effective",
  "table.context.blinds": "Blinds",
  "table.context.ante": "Ante",
  "table.context.activePlayers": "In hand",
  "table.context.dealtIn": "Dealt in",
  "table.context.pot": "Pot",
  "table.context.toCall": "To call",
  "table.context.bigBlinds": "{count} bb",
  "table.context.pushFold": "Push/fold depth",
  "table.context.ariaLabel": "Situation: {stack} chips, {bigBlinds} big blinds, blinds {blinds}, pot {pot}, {toCall} to call, {activePlayersInHand} active players in hand.",
  ...
  "review.accuracy": "{accuracy}% model-best (within 0.02 BB)",
  "review.goodAccuracy": "{accuracy}% good (within 0.35 BB)",
  "review.decisionCount": "{count} decisions reviewed",
  "review.approximationNotice":
    "These are this game's own estimates, not solved play. Equity comes from a bounded simulation, and tournament pressure is an ICM-inspired heuristic rather than a payout solver, so treat close calls as close.",
  "review.truncated":
    "Only the first {count} decisions were scored; this review reached its safety limit.",
  "review.timelineLabel": "Decision timeline",
  "review.handStreet": "Hand {handNumber} · {street}",
  "review.potLabel": "pot {pot}",
  "review.handPlayers": "{count} players in hand",
  "review.handOpponentSingular": "{count} active opponent",
  "review.handOpponentsPlural": "{count} active opponents",
  "review.handDealtIn": "{count} dealt in",
  "review.tournamentPlayersRemaining":
    "{count} players remaining in tournament",
  "review.preflopContext": "Preflop context: {context}",
  "review.preflop.unopened": "no raise yet",
  "review.preflop.facing-open": "facing an open",
  "review.preflop.facing-3bet": "facing a 3-bet",
  "review.preflop.facing-4bet-plus": "facing a 4-bet or larger",
  ...
  "review.noDecisions": "No recorded decisions yet.",
  "review.unavailable": "Unavailable",
  "review.inspectCalculation": "Inspect calculation",
  "review.closeCalculation": "Close calculation",
  "review.navigationLabel": "Review navigation",
  "review.analysisLabel": "Review analysis",
  "review.mathLabel": "Decision mathematics",
  "review.mathHeading": "The math",
  "review.nav.next": "Next",
  "review.nav.nextKeyMove": "Next key move",
  "review.tab.math": "Math",
  "review.tab.alternatives": "Alternatives",
  "review.nav.moveOn": "Move On",
  "review.summaryLabel": "Review summary",
  "review.goodMovesShare": "Good Moves",
  "review.accuracyLabel": "Accuracy",
  "review.moveLabel": "move",
  "review.movesLabel": "moves",
  "review.modelBestShare": "Model best",
  "review.decisionSelectLabel": "Decision",
  "review.decisionOption": "{position} · {hand} · {quality}",
  "review.notableTag": "Key move",
  "review.math.effectiveStack": "Effective stack (BB)",
  ...
  "review.quality.best": "Model-best",
  ...
  "review.action.open-fold": "Open-fold",
  "review.action.open-limp": "Open-limp",
  "review.action.open-raise": "Open-raise",
  "review.action.limp-fold": "Limp-fold",
  "review.action.limp-call": "Limp-call",
  "review.action.limp-raise": "Limp-raise",
  "review.action.fold-to-open": "Fold to open",
  "review.action.fold-to-3bet": "Fold to 3-bet",
  "review.action.fold-to-4bet-plus": "Fold to 4-bet+",
  "review.action.overcall": "Overcall",
  "review.action.isolation-raise": "Isolation raise",
  "review.action.three-bet": "3-bet",
  "review.action.four-bet-plus": "4-bet+",
  ...
  "review.math.requiredEquityReference":
    "Pot-odds reference (not a direct EV threshold)",
  "review.math.estimatedEquity": "Equity you had (estimated)",
  "review.math.showdownEquity": "Showdown equity vs current-hand ranges",
  "review.math.foldEquity": "Chance they fold",
  "review.math.opponentsAbleToRespond": "Opponents able to respond",
  "review.math.confidence": "Estimate confidence / 95% interval",
  "review.math.source": "Model source",
  "review.source.preflop": "Conservative preflop continuation rollout",
  "review.source.postflop": "Action-conditioned postflop range-response rollout",
  ...
  "review.math.blindUrgency": "Blind pressure",
  "review.math.bigBlindNext": "big blind next hand",
  ...
  "dashboard.ceremony.tryAgain": "Try again",
  ...
  "table.modePreview.handSummary":
    "Hand {handNumber} · {tournamentPlayersRemaining} tournament players remain",
  "table.modePreview.handPlayers":
    "Current hand: {activePlayersInHand} active of {playersDealtIn} dealt in",
  ...
  "table.status.streetPlayersInHand": "{street} · {playersInHand} players in hand",
  ...
  "resumeRecap.line.potTournamentPlayers":
    "Pot: {chips} chips · {tournamentPlayersRemaining} players remain in tournament",
