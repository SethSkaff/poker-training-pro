...
(() => {
  ...
  // src/locales/en-US.messages.shell.ts
  var SHELL_MESSAGES = Object.freeze({
    ...
    "settings.header.controllerHint": "Controller: D-pad move · A select · B back · D-pad ←/→ adjust sliders",
    "settings.audio.heading": "Audio",
    "settings.audio.previewStatusDefault": "Choose Preview to hear the saved Master or Table effects level.",
    ...
    "settings.audio.muteAll.description": "Silence music and table effects without changing their levels.",
    "settings.audio.master.label": "Master",
    "settings.audio.master.description": "Controls the combined level of all available game audio.",
    "settings.audio.master.previewLabel": "Preview Master volume at {percent} percent",
    "settings.audio.music.label": "Music",
    "settings.audio.music.description": "Preview unavailable — no approved licensed music masters are installed.",
    "settings.audio.music.previewUnavailableLabel": "Music preview unavailable",
    "settings.audio.effects.label": "Table effects",
    "settings.audio.effects.description": "Controls card, chip, fold, and result cues.",
    ...
    "audioPreview.effectsPlayed": "Table effects preview played at {percent} percent.",
    ...
    "audioPreview.unavailable": "Audio preview is unavailable on this device. Your settings were kept.",
    ...
    "settings.display.reduceMotion.description": "Use quiet fades instead of camera and object travel.",
    "settings.display.highContrast.label": "High contrast & four-color deck",
    "settings.display.highContrast.description": "Strengthen table edges and distinguish every suit.",
    ...
    "settings.display.interfaceScale.hint": "Changes the size of menus, table labels, and action controls. You can scroll a larger interface; gameplay information is never hidden.",
    ...
    "settings.camera.autoMovement.description": "Play the room arrival and recenter your view at the start of a new hand.",
    ...
    "settings.motion.hint": "Tune each surface independently. Reduce motion above remains a one-click safety override and temporarily stops every category.",
    ...
    "settings.motion.room.description": "The championship-floor approach before a seat is shown.",
    "settings.motion.camera.label": "Camera movement",
    "settings.motion.camera.description": "Automatic recentering and the eased table-view response.",
    "settings.motion.table.label": "Card and chip flourish",
    "settings.motion.table.description": "Deal, fold, chip-push, and opponent thinking effects.",
    "settings.motion.transition.label": "Screen transitions",
    "settings.motion.transition.description": "Mode changes and the between-hand progress overlay.",
    "settings.controls.heading": "Controls",
    "settings.controls.hint": "Rebind keyboard and controller actions. Conflicts and reserved system keys are flagged; reset either device to its defaults.",
    ...
    "saveData.intro": "Desktop progress is stored in a protected local journal. Browser storage is never used as the authoritative desktop save.",
    "saveData.status.default": "Exports are local files. Import and reset always require a preview and confirmation.",
    ...
    "saveData.error.unknownFormat": "The backup belongs to an unknown application or save format.",
    "saveData.error.unsupportedVersion": "This backup was created by an unsupported save version.",
    "saveData.error.versionedIncomplete": "The versioned backup is missing settings or player progress.",
    "saveData.error.legacyIncomplete": "The legacy backup does not contain settings or player progress.",
    "saveData.error.lastKnownGoodWriteFailed": "The last-known-good backup could not be written.",
    "saveData.error.lastKnownGoodReadFailed": "The last-known-good backup could not be read.",
    "saveData.error.lastKnownGoodUnavailable": "No last-known-good backup is available.",
    ...
    "saveData.confirm.importPreview": "This valid save contains {resultCount} recorded results and {trainingCompleted} completed training hands. Ratings: decision {decisionElo}, math {mathElo}, tournament {tournamentElo}. It will replace both settings and progress.",
    ...
    "recovery.confirm.startFreshLabel": "Starting fresh archives existing save files before creating a new profile. Nothing is discarded silently. Continue?",
    ...
    "about.privacyIntro": "This build plays fully offline with no account, ads, analytics, or remote uploads. The full policy is bundled below.",
    "about.privacyPolicySummary": "Privacy policy",
    "about.privacyPolicyUnavailable": "The bundled privacy policy is unavailable in this preview.",
    "about.privacyPolicyBlocked": "A stable public HTTPS copy of this policy is a separate item that is still blocked pending the publisher.",
    "about.supportHeading": "Support",
    "about.supportBlocked": "Support contact: pending publisher assignment. No email or web address is published yet.",
    "about.desktopUnavailable": "Version, folder, and bundled-document details are available in the desktop app.",
    ...
    "controls.conflict.alert": "Some {device} controls share a binding. Duplicate controls are highlighted below.",
    ...
    "controls.capture.reservedNotice": "{keyName} is a reserved system key. Choose another key or press Esc to cancel.",
    ...
    "playChipAck.body": "Poker Training Pro is a poker trainer. Play chips only. Chips have no cash value, and there is no real-money wagering, no deposits, no purchases, and no withdrawals. There is nothing to win or lose but practice.",
    "playChipAck.followUp": "This message appears once. You can revisit the details any time from Settings.",
    ...
    "shell.error.tournamentReplayFailed": "The saved tournament checkpoint could not be replayed. Your ratings and training progress are still safe.",
    "shell.safeMode.eyebrow": "Recovery launch",
    "shell.safeMode.title": "Safe mode is protecting this session",
    "shell.safeMode.description": "Poker Training Pro detected repeated startup or renderer failures. Hardware acceleration is disabled, animation is reduced, audio is muted, and quick dealing is forced for this launch. Your saved preferences and poker progress have not been replaced.",
    "shell.safeMode.recoveryCountRepaired": "Recovery count: {failureCount}. A damaged recovery marker was repaired.",
    "shell.safeMode.recoveryCountValid": "Recovery count: {failureCount}. The recovery marker passed validation.",
    ...
    "shell.import.summary": "Player {playerName} has completed {trainingCompleted} training scenarios across {resultCount} recorded results.",
    ...
    "shell.saveFailure.detail": "Gameplay is blocked until the protected save succeeds, so your progress cannot silently diverge from disk.",
    ...
    "shell.firstRun.intro": "Choose a quiet starting setup before camera motion or timed play begins. You can change every option later in Settings.",
    "shell.firstRun.reduceMotion.label": "Reduce motion",
    "shell.firstRun.reduceMotion.description": "Replace room travel and card movement with calm fades.",
    "shell.firstRun.highContrast.label": "High contrast and four-color deck",
    "shell.firstRun.highContrast.description": "Strengthen edges and distinguish suits without color alone.",
    "shell.firstRun.startMuted.label": "Start muted",
    "shell.firstRun.startMuted.description": "All decisions remain fully readable without audio.",
    "shell.firstRun.keyboardHint": "Keyboard: arrow keys and Tab navigate menus; Space/Enter activate; F folds, C calls/checks, 2 raises double, R raises custom, and Esc pauses.",
    ...
    "shell.resumeTournament.summary": "{eventName} is waiting at hand {handNumber}. The deck and decisions were reconstructed from the protected seed and public action log.",
    ...
    "shell.resumeTraining.summary": "{scenarioTitle} is ready at the table. Your answer and score have not been submitted yet.",
  ...
  // src/locales/en-US.messages.gameplay.ts
  var EN_US_GAMEPLAY_MESSAGES = Object.freeze({
    ...
    "modes.normal.description": "Strong opponents with pressure, personalities, and selective bluffs.",
    "modes.rational.tag": "Mathematical tournament field",
    "modes.rational.name": "Rational",
    "modes.rational.description": "Range-aware opponents following explicit information-set policy.",
    "modes.training.tag": "One decision at a time",
    "modes.training.name": "Training",
    "modes.training.description": "Focused poker situations with one linked math question and feedback.",
    "modes.timed.tag": "Fit a table into your schedule",
    "modes.timed.name": "Timed Table",
    "modes.timed.description": "Normal opponents at one table for the time you choose.",
    ...
    "dashboard.timed.note": "One table · Normal opponents · No career progression",
    ...
    "dashboard.tour.disclosure": "Six-seat local simulation. Qualification ratios and blind structure come from the full career event.",
    ...
    "dashboard.ceremony.exportHint": "Export a redacted, play-safe replay of this event for a bug report.",
    // --- RoomFlythrough.tsx ---------------------------------------------------
    ...
    "tutorial.step.peek.instruction": "Your hole cards belong only to you. Click the cards to reveal them.",
    "tutorial.step.legalAction.eyebrow": "2 · Legal actions",
    "tutorial.step.legalAction.title": "Use only the available choice",
    "tutorial.step.legalAction.instruction": "You face no bet, so checking continues for zero chips. Calling is not possible and raising is closed in this practice beat.",
    "tutorial.step.betSizing.eyebrow": "3 · Bet sizing",
    "tutorial.step.betSizing.title": "Choose a legal amount",
    "tutorial.step.betSizing.instruction": "The minimum is 400 and your maximum is 1,200. A 600-chip bet is 50% of the 1,200-chip pot.",
    "tutorial.step.showdown.eyebrow": "4 · Hand flow",
    "tutorial.step.showdown.title": "Be patient during an all-in runout",
    "tutorial.step.showdown.instruction": "No decision is pending: both players are all-in. Deal the turn and river one at a time, then compare five-card hands at showdown.",
    "tutorial.step.math.eyebrow": "5 · Read the numbers",
    "tutorial.step.math.title": "Chips are not odds",
    "tutorial.step.math.instruction": "These four ideas answer different questions. Read them before continuing.",
    "tutorial.step.speed.eyebrow": "6 · Presentation speed",
    "tutorial.step.speed.title": "Set the table’s pace",
    "tutorial.step.speed.instruction": "Speed changes how quickly opponents and cards are presented, never the cards, legal actions, or AI policy. Choose any speed except 1×.",
    "tutorial.step.complete.eyebrow": "Tutorial complete",
    "tutorial.step.complete.title": "You are ready for the table",
    "tutorial.step.complete.instruction": "You peeked, checked a legal action, sized a bet, waited for showdown, read the core math, and changed presentation speed.",
    ...
    "tutorial.showdown.waitRiver": "The turn makes your flush. The river still must be dealt before the pot is awarded.",
    ...
    "tutorial.math.expectedValue.desc": "Average chips won or lost across repeated decisions.",
    "tutorial.complete.unscored": "Practice is unscored.",
    "tutorial.complete.nextSteps": "Start Training for coached decisions or a Tour for full hands.",
    ...
    "table.feedback.chooseRegret": "You chose {action} and gave up {regret}bb versus the modeled best action, {bestAction}.",
    ...
    "table.modePreview.timedCopy": "Normal opponents share one escalating table. The blind director increases pressure as your deadline approaches.",
    "table.modePreview.rationalCopy": "Opponents follow explicit range, equity, and pot-odds policies. Review their logic after the hand.",
    "table.modePreview.normalCopy": "Opponents stay fundamentally sound while changing tempo, bluff frequency, and pressure.",
    "table.modePreview.yourSeat": "Your seat",
    "table.modePreview.playerFallback": "Player",
    "table.modePreview.handSummary": "Hand {handNumber} · {playersRemaining} of {fieldSize} players remain",
    "table.modePreview.timeRemainingLabel": "Scheduled time remaining",
    "table.modePreview.blindsRiseNote": "Blinds only rise; deadline pressure forces the field toward heads-up.",
    ...
    "table.error.actionUnavailable": "That action is not available in this practice scenario.",
    "table.error.mathEstimatePercent": "Enter a valid percentage, fraction, or ratio estimate.",
    ...
    "table.spectator.skipAriaLabel": "Skip opponent presentation and continue the hand",
    ...
    "table.controls.controllerHint": "Controller: A check/call, X fold, Y raise, LB peek, View pause, d-pad camera. B goes back in menus.",
    ...
    "table.formula.spr.desc": "Effective stack divided by the pot at the start of the street",
    "table.formula.minRaise.label": "Minimum raise",
    "table.formula.minRaise.desc": "At least the size of the last full bet or raise",
    "table.formula.sidePot.label": "Side pot",
    "table.formula.sidePot.desc": "Separate chips contested only by players who matched them",
    "table.formula.bubble.label": "Bubble",
    "table.formula.bubble.desc": "The last finish before a qualification or prize cutoff",
    "table.formula.workedCall.label": "Worked call",
    "table.formula.workedCall.desc": "Calling 200 into a final pot of 800 costs 25%. Continue when estimated equity is above 25%, before tournament-risk adjustments.",
    "table.formula.shortcut.label": "Shortcut",
    "table.formula.shortcut.desc": "Nine flush outs from the flop are roughly 36% to improve by the river.",
    ...
    "table.formula.expectedValue.desc": "Win value − loss cost, weighted by probability",
    ...
    "prompts.allIn.message": "An all-in player cannot wager again. Other players may keep betting if at least two of them still have chips.",
    "prompts.sidePot.title": "Side pot",
    "prompts.sidePot.message": "Each player can win only the chips they matched. Extra chips form a side pot contested by the deeper stacks.",
    "prompts.minimumRaise.title": "Minimum raise",
    "prompts.minimumRaise.message": "A raise must add at least the size of the previous bet or raise. Smaller increases are illegal, which sets the floor on your raise slider.",
    "prompts.blindIncrease.title": "Blinds went up",
    "prompts.blindIncrease.message": "Every stack is now shorter measured in big blinds. Waiting for premium hands costs more each orbit, so wider aggression becomes correct.",
    "prompts.elimination.title": "A player busted",
    "prompts.elimination.message": "The field is smaller. The blinds reach you more often and each remaining pot is worth a larger share of the payouts.",
    "prompts.qualification.title": "In the qualifying places",
    "prompts.qualification.message": "Surviving now banks the result. Weigh tournament survival against raw chip expected value before committing a big stack.",
    "prompts.eloChange.title": "Your Elo moved",
    "prompts.eloChange.message": "Elo tracks decision and math skill against calibrated bots, not chips won. A single hand rarely swings it far, so keep playing your reads.",
    ...
    "resumeRecap.line.potPlayers": "Pot: {chips} chips · {playersRemaining} players left",
    "resumeRecap.line.decision": "Your decision: {decision}",
    "resumeRecap.line.awayCounts": "Away for {duration}.",
    "resumeRecap.line.awayExcluded": "Away for {duration}; that time was not counted against your play.",
    ...
    "actionMap.menu.left.pointerHint": "Drag a slider left or move to the previous control",
    "actionMap.menu.right.label": "Move focus right / increase",
    "actionMap.menu.right.pointerHint": "Drag a slider right or move to the next control",
    ...
    "actionMap.game.fold.pointerHint": "Click Fold, or drag the hole cards toward the dealer",
    ...
    "actionMap.game.raiseCustom.pointerHint": "Click Raise to open the bet composer",
    "actionMap.game.raiseDouble.label": "Raise 2× big blind",
    "actionMap.game.raiseDouble.pointerHint": "Choose the 2× preset in the bet composer",
    "actionMap.game.raiseTwoFive.label": "Raise 2.5× big blind",
    "actionMap.game.raiseTwoFive.pointerHint": "Choose the 2.5× preset in the bet composer",
    "actionMap.game.raiseTriple.label": "Raise 3× big blind",
    "actionMap.game.raiseTriple.pointerHint": "Choose the 3× preset in the bet composer",
  ...
  // src/locales/en-US.messages.ts
  var EN_US_MESSAGES = Object.freeze({
  ...
  // src/lib/localeMessages.ts
  var MESSAGE_LOCALE_RESOURCE_VERSION = 1;
  function formatMessage(key, values = {}, locale = EN_US_MESSAGES) {
  ...
  function assertMessageLocale(locale) {
    if (locale.resource !== "poker-training-pro-message-locale" || locale.version !== MESSAGE_LOCALE_RESOURCE_VERSION || !locale.id || !locale.intlLocale || locale.direction !== "ltr" && locale.direction !== "rtl" || Intl.NumberFormat.supportedLocalesOf([locale.intlLocale]).length !== 1 || !locale.messages || Object.values(locale.messages).some((value) => typeof value !== "string")) {
  ...
  function createSessionResult(session, finishPlace) {
    ...
    return {
      ...
      qualificationLabel: finishPlace <= qualifyingPlaces ? formatMessage("career.result.qualified") : formatMessage("career.result.notQualified", { qualifyingPlaces }),
      unlockedEventIds,
